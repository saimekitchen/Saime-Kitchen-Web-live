...
Bởi vì đôi khi, những khoảnh khắc tuyệt vời nhất lại diễn ra quanh một chiếc bàn.`,
    ...
    tasteFoodDesc: "Buổi thử nghiệm A/B đơn giản và lôi cuốn so sánh giữa các loại nguyên liệu thô, truyền thống và hiện đại. Tìm hiểu cách thay đổi một biến số duy nhất như muối, tiêu và giấm bản địa có thể chuyển hóa hoàn toàn hương vị món ăn.",
    tasteCoffeeTitle: "Nghệ Thuật Cà Phê Thủ Công",
    tasteCoffeeDesc: "Hành trình thử nghiệm A/B so sánh các biến số pha chế. Đối chiếu sự khác biệt giữa Robusta và Arabica, so sánh chiết xuất phin nhanh so với phin chậm, và đánh giá sự hòa quyện của các tỷ lệ béo của sữa với mẻ rang thủ công.",
    tasteCocktailTitle: "Flavour Flight Cocktail Bản Địa",
    tasteCocktailDesc: "Buổi thử nghiệm hương vị A/B tương tác sâu sắc về nghệ thuật cân bằng. Thực hiện nếm mù so sánh giữa thảo mộc tự nhiên, chất tạo ngọt tự nấu và các loại axit hữu cơ để khám phá gu thưởng thức riêng của bạn.",
