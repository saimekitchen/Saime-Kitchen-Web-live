...
export const MENU_ITEM_TRANSLATIONS: Record<string, {
  ...
  'saime-comfort': {
    ...
    ingredients: ['Bắp ngọt', 'Cà rốt', 'Đậu xanh', 'Muối mè', 'Dừa bào xợi'],
  },
  'xoi': {
    name: 'XÔI MẶN',
  ...
  'chicken-salad': {
    ...
    ingredients: ['Ức gà Sous Vide', 'Rau xanh tổng hợp'],
  },
  'garden-salad': {
    name: 'SALAD',
    ...
    ingredients: ['Xà lách', 'Xà lách lolo tím', 'Cải mầm', 'Dưa leo', 'Cà chua bi', 'Hành tím', 'Hành tây trắng', 'sốt mayo cay'],
  },
  'chicken-nugget': {
