...
export default function Header({ 
  ...
  const navItems = [
    ...
    { label: 'Healthy Menu', value: 'healthy-menu' },
  ...
  return (
    <header
      id="main-header"
      className="fixed top-0 left-0 right-0 z-50 flex flex-col transition-all duration-300 select-none translate-y-0"
    >
      {/* Main Navbar */}
      <div
