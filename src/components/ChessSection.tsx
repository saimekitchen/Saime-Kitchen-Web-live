                ...
                <AnimatePresence mode="wait">
                  {!submitted ? (
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        <label className="block font-sans font-black text-[9px] uppercase tracking-wider text-neutral-400">
                          {lang === 'en' ? 'Contact Details (Messenger/Zalo/Phone)' : 'Phương Thức Liên Hệ'} <span className="text-amber-500">*</span>
                        </label>
                        <input
                          type="text"
                          required
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="font-sans text-neutral-400 text-[11px] leading-relaxed max-w-xs mx-auto">
                          {lang === 'en'
                            ? 'Our hosts are finding you a player! Check your Messenger for matching notification.'
