          ...
          {currentMenuTab === 'bistro' && (
            <div className="flex gap-1 p-0.5 bg-black/5 dark:bg-white/5 rounded-full max-w-[320px] mx-auto mb-2.5 animate-fade-in">
              ...
              >
                ...
                <span>{lang === 'en' ? 'Healthy' : 'Lành Mạnh'}</span>
              </button>
              <button
                onClick={() => {
            ...
            <div id="menu-search-filters" className="mb-12">
              ...
              {currentMenuTab === 'bistro' && (
                <div className="flex justify-center mb-6">
                  <div className="inline-flex p-1 bg-sand/65 border border-sand-dark/45 rounded-full select-none shadow-xs">
                    <button
                      onClick={() => {
                        setFoodMenuDivision('healthy');
                        setSelectedCategory('Main Course');
                      }}
                      className={`flex items-center gap-2 px-6 py-2 rounded-full font-display font-black text-xs uppercase tracking-widest transition-all cursor-pointer ${
                        foodMenuDivision === 'healthy'
                    ...
                    >
                      ...
                      {lang === 'en' ? 'Healthy Menu' : 'Thực Đơn Lành Mạnh'}
                    </button>
                    <button
                      onClick={() => {
                        setFoodMenuDivision('casual');
                    ...
                    >
                      ...
                      {lang === 'en' ? 'Casual Menu' : 'Thực Đơn Tự Do'}
                    </button>
                    <button
                      onClick={() => {
                        setFoodMenuDivision('vegetarian');
                    ...
                    >
                      ...
                      {lang === 'en' ? 'Vegetarian Only' : 'Món Chay'}
                    </button>
                  </div>
                </div>
              )}
