  ...
  const packages = [
    {
      ...
      duration: lang === 'en' ? '90 mins' : '90 phút',
      groupSize: lang === 'en' ? '4-8 people' : '4-8 khách',
      image: '/src/assets/images/regenerated_image_1781695964450.jpg',
      badge: lang === 'en' ? 'Chef Guided' : 'Bếp Trưởng Dẫn Dắt'
    },
    {
      id: 'coffee',
      ...
      duration: lang === 'en' ? '60 mins' : '60 phút',
      groupSize: lang === 'en' ? '2-6 people' : '2-6 khách',
      image: '/src/assets/images/regenerated_image_1781695966359.jpg',
      badge: lang === 'en' ? 'Slow Brews' : 'Pha Chế Thủ Công'
    },
    {
      id: 'cocktail',
      ...
      duration: lang === 'en' ? '75 mins' : '75 phút',
      groupSize: lang === 'en' ? '4-10 people' : '4-10 khách',
      image: '/src/assets/images/regenerated_image_1781695972384.jpg',
      badge: lang === 'en' ? 'Botanical Craft' : 'Cocktail Thảo Mộc'
    }
  ];
